...
import {ActionNode, StateNode, ProvenanceGraph, I18nextManager, AVisInstance, IVisInstance, Range, SelectionUtils, SelectOperation, SlideNode, ActionMetaData} from 'phovea_core';
    ...
    $p.html(`
      ...
      <div>
        ...
        <div class="btn-group" role="group">
          ...
          <label class="form-label btn btn-outline-secondary btn-sm" for="btncheck_data" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.dataActions')}">
            <i class="fas fa-database"></i>
          </label>
          <input type="checkbox" class="btn-check" autocomplete="off" id="btncheck_visual" name="category" value="visual">
          <label class="form-label btn btn-outline-secondary btn-sm" for="btncheck_visual" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.visualActions')}">
            <i class="fas fa-chart-bar"></i>
          </label>
          <input type="checkbox" class="btn-check" autocomplete="off" id="btncheck_selection" name="category" value="selection">
          <label class="form-label btn btn-outline-secondary btn-sm" for="btncheck_selection" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.selectionActions')}">
            <i class="fas fa-pen-square"></i>
          </label>
          <input type="checkbox" class="btn-check" autocomplete="off" id="btncheck_layout" name="category" value="layout">
          <label class="form-label btn btn-outline-secondary btn-sm" for="btncheck_layout" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.layoutActions')}">
            <i class="fas fa-desktop"></i>
          </label>
          <input type="checkbox" class="btn-check" autocomplete="off" id="btncheck_logic" name="category" value="logic">
          <label class="form-label btn btn-outline-secondary btn-sm" for="btncheck_logic" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.logicActions')}">
        ...
        <div class="btn-group" role="group">
          ...
          <label class="form-label btn btn-outline-secondary btn-sm" for="btncheck_create" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.createActions')}">
             <i class="fas fa-plus"></i>
          </label>
          <input type="checkbox" class="btn-check" autocomplete="off" id="btncheck_update" name="operation" value="update">
          <label class="form-label btn btn-outline-secondary btn-sm" for="btncheck_update" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.updateActions')}">
             <i class="fas fa-sync"></i>
          </label>
          <input type="checkbox" class="btn-check" autocomplete="off" id="btncheck_remove" name="operation" value="remove">
          <label class="form-label btn btn-outline-secondary btn-sm" for="btncheck_update" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.removeActions')}">
      ...
      <input type="checkbox" class="btn-check" autocomplete="off" id="btncheck_vertical_1" name="category" value="data">
        <label class="form-label btn btn-outline-secondary btn-sm" for="btncheck_vertical_1" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.dataActions')}">
        ...
        <label class="form-label btn btn-outline-secondary btn-sm" for="btncheck_vertical_2" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.visualActions')}">
        ...
        <label class="form-label btn btn-outline-secondary btn-sm" for="btncheck_vertical_3" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.selectionActions')}">
        ...
        <label class="form-label btn btn-outline-secondary btn-sm" for="btncheck_vertical_4" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.layoutActions')}">
        ...
        <label class="form-label btn btn-outline-secondary btn-sm" for="btncheck_vertical_5" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.logicActions')}">
