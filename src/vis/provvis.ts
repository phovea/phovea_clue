    ...
    $p.html(`
      ...
      <div>
        ...
        <div class="btn-group btn-group-toggle" data-toggle="buttons">
          <label class="btn btn-secondary btn-sm" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.dataActions')}">
            <input type="checkbox" autocomplete="off" name="category" value="data" > <i class="fas fa-database"></i>
          </label>
          <label class="btn btn-secondary btn-sm" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.visualActions')}">
            <input type="checkbox" autocomplete="off" name="category" value="visual"> <i class="fas fa-chart-bar"></i>
          </label>
          <label class="btn btn-secondary btn-sm" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.selectionActions')}">
            <input type="checkbox" autocomplete="off" name="category" value="selection"> <i class="fas fa-pen-square"></i>
          </label>
          <label class="btn btn-secondary btn-sm" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.layoutActions')}">
            <input type="checkbox" autocomplete="off" name="category" value="layout"> <i class="fas fa-desktop"></i>
          </label>
          <label class="btn btn-secondary btn-sm" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.logicActions')}">
            <input type="checkbox" autocomplete="off" name="category" value="logic"> <i class="fas fa-cog"></i>
          </label>
        </div>

        <div class="btn-group btn-group-toggle" data-toggle="buttons">
          <label class="btn btn-secondary btn-sm" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.createActions')}">
            <input type="checkbox" autocomplete="off" name="operation" value="create"> <i class="fas fa-plus"></i>
          </label>
          <label class="btn btn-secondary btn-sm" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.updateActions')}">
            <input type="checkbox" autocomplete="off" name="operation" value="update"> <i class="fas fa-sync"></i>
          </label>
          <label class="btn btn-secondary btn-sm" title="${I18nextManager.getInstance().i18n.t('phovea:clue.provvis.removeActions')}">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                <div class="dropdown-item input-group input-group-sm">
