...
export class Renderer {
    ...
    renderAnnotationsImpl(state) {
        ...
        //move
        $annsEnter.append('button').attr('tabindex', -1).attr('class', 'btn btn-secondary btn-sm fas fa-arrows-alt').call(d3.behavior.drag()
        ...
        //remove
        $annsEnter.append('button').attr('tabindex', -1).attr('class', 'btn btn-secondary btn-sm fas fa-times')
        ...
        $anns.filter((d) => d.type === 'frame').call(($frames, $framesEnter) => {
            ...
            //resize
            $framesEnter.append('button').attr('tabindex', -1).attr('class', 'btn btn-secondary btn-sm fas fa-expand fa-flip-horizontal')
                .call(d3.behavior.drag()
                .on('dragstart', function (d, i) {
                that.renderAnchors(bounds);
            })
