  ...
  <div class="content">
    ...
    <aside class="annotations" style="display:none">
      ...
      <div class="btn-group" role="group" aria-label="annotations">
        <button class="btn btn-default btn-sm" title="${I18nextManager.getInstance().i18n.t('phovea:clue.ClueWrapper.addTextAnnotation')}" data-ann="text"><i class="fas fa-font"></i>
        </button>
        <button class="btn btn-default btn-sm" title="${I18nextManager.getInstance().i18n.t('phovea:clue.ClueWrapper.addArrow')}" data-ann="arrow"><i class="fas fa-arrow-right"></i>
        </button>
        <button class="btn btn-default btn-sm" title="${I18nextManager.getInstance().i18n.t('phovea:clue.ClueWrapper.addFrame')}" data-ann="frame"><i class="far fa-square"></i>
        </button>
      </div>
    </aside>
  </div>
