 ...
 */
import { UserSession, I18nextManager } from 'phovea_core';
...
export class ProvenanceGraphMenu {
    ...
    init(parent) {
        ...
        <a class="nav-link dropdown-toggle" href="#" id="sessionDropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
          <i class="fas fa-code-branch fa-lg fa-rotate-180 fa-fw"></i>
        </a>
        <ul class="dropdown-menu" id="provenancegraph_list" aria-labelledby="sessionDropdown">
